...
class AplikasiTapCoreSamplingController extends Controller
{
    public function index(){
        return view('aplikasi.tap_core_sampling');
    }
    ...
    public function process(Request $request){
        ...
        if(Rit::where('spta', $data['spta'])->count() > 0){
            ...
            if(AriSampling::where('rit_id', $rit_id)->count() == 0){
                ...
                return view('aplikasi.tap_sudah_core_sampling');
            }
            return view('aplikasi.tap_sukses_core_sampling');
        }
        else
        {
    ...
    public function tap_sukses_core_sampling(){
        return view('aplikasi.tap_sukses_core_sampling');
    }
