...
class EnsureRoleUserIs9
{
    ...
    public function handle(Request $request, Closure $next)
    {
        switch(Auth()->user()->role_id)
        {
            ...
            case 6 : return $next($request); break;
            case 7 : return $next($request); break;
            case 8 : return $next($request); break;
            case 9 : return $next($request); break;
