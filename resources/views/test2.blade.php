...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h5 class="m-0 font-weight-bold text-primary">{{ ucfirst('scoring') }} Reward & Punishment</h5>
        </div>
        <div class="card-body">

            <div class="table-responsive">
                <form action="{{ route("scoring_ganti_tanggal") }}" method="POST">
                    @csrf
                    <label><strong>Ganti {{ ucfirst("tanggal") }}</strong></label>
                    <input type="date" value="{{ $date }}" name="date" class="form-control" onchange="this.form.submit()">
                </form>
                <br>
                <table class="table table-bordered text-dark table-hover table-striped" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        {{-- @if($score["core"] != 0 || $score["core"] != NULL) --}}
                        <tr>
                            <td>{{ $i }}</td>
